...
export function cacheDiscordUser(id: string, username: string, globalName: string | null, avatarHash: string | null): void {
    userCache.set(id, { username, globalName, avatarHash });
}
...
export function enrichWithDiscordUser(id: string | undefined): { displayName: string | null; avatarUrl: string | null } {
    if (!id) return { displayName: null, avatarUrl: null };
